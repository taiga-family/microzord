"use strict";
(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[791],{
...
/* harmony export */ });
/* harmony import */ var _util_EmptyError__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9350);
/* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5964);
/* harmony import */ var _take__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6697);
/* harmony import */ var _defaultIfEmpty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9901);
/* harmony import */ var _throwIfEmpty__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3774);
...
/* harmony export */ });
/* harmony import */ var _util_EmptyError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9350);
/* harmony import */ var _util_lift__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9974);
/* harmony import */ var _OperatorSubscriber__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4360);
...
var observable_throwError = __webpack_require__(8810);
...
// EXTERNAL MODULE: consume shared module (default) @angular/common@=17.3.12 (strict) (singleton) (fallback: ./node_modules/@angular/common/fesm2022/common.mjs)
...
var first = __webpack_require__(1594);
...
var throwIfEmpty = __webpack_require__(3774);
...
function last(predicate, defaultValue) {
  const hasDefaultValue = arguments.length >= 2;
  return source => source.pipe(predicate ? (0,filter/* filter */.p)((v, i) => predicate(v, i, source)) : identity/* identity */.D, takeLast(1), hasDefaultValue ? (0,defaultIfEmpty/* defaultIfEmpty */.U)(defaultValue) : (0,throwIfEmpty/* throwIfEmpty */.v)(() => new EmptyError/* EmptyError */.G()));
}
...
function wrapIntoObservable(value) {
  if ((0,isObservable/* isObservable */.A)(value)) {
    return value;
  }
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, injector) {
  return (0,from/* from */.H)(checks).pipe((0,mergeMap/* mergeMap */.Z)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, injector)), (0,first/* first */.$)(result => {
    return result !== true;
  }, true));
}
...
function runCanActivate(futureRSS, futureARS, injector) {
  ...
  const canActivateObservables = canActivate.map(canActivate => {
    return (0,defer/* defer */.v)(() => {
      ...
      return wrapIntoObservable(guardVal).pipe((0,first/* first */.$)());
    });
  });
...
function noMatch$1(segmentGroup) {
  return (0,observable_throwError/* throwError */.$)(new NoMatch(segmentGroup));
}
function absoluteRedirect(newTree) {
  return throwError(new AbsoluteRedirect(newTree));
}
function namedOutletsRedirect(redirectTo) {
  return (0,observable_throwError/* throwError */.$)(new core_mjs_["ɵRuntimeError"](4000 /* RuntimeErrorCode.NAMED_OUTLET_REDIRECT */, (typeof ngDevMode === 'undefined' || ngDevMode) && `Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}
function canLoadFails(route) {
  return (0,observable_throwError/* throwError */.$)(navigationCancelingError((typeof ngDevMode === 'undefined' || ngDevMode) && `Cannot load children because the guard of the route "path: '${route.path}'" returned false`, NavigationCancellationCode.GuardRejected));
}
...
class Recognizer {
  ...
  recognize() {
    ...
    return this.match(rootSegmentGroup).pipe((0,map/* map */.T)(children => {
  ...
  match(rootSegmentGroup) {
    ...
    return expanded$.pipe((0,catchError/* catchError */.W)(e => {
  ...
  processSegmentGroup(injector, config, segmentGroup, outlet) {
    ...
    return this.processSegment(injector, config, segmentGroup, segmentGroup.segments, outlet, true).pipe((0,map/* map */.T)(child => child instanceof TreeNode ? [child] : []));
  }
  /**
  ...
  processSegment(injector, routes, segmentGroup, segments, outlet, allowRedirects) {
    return (0,from/* from */.H)(routes).pipe((0,concatMap/* concatMap */.H)(r => {
      return this.processSegmentAgainstRoute(r._injector ?? injector, routes, r, segmentGroup, segments, outlet, allowRedirects).pipe((0,catchError/* catchError */.W)(e => {
        if (e instanceof NoMatch) {
          return (0,of.of)(null);
        }
        throw e;
      }));
    }), (0,first/* first */.$)(x => !!x), (0,catchError/* catchError */.W)(e => {
      if (isEmptyError(e)) {
    ...
    return matchResult.pipe((0,switchMap/* switchMap */.n)(result => {
      ...
      return this.getChildConfig(injector, route, segments).pipe((0,switchMap/* switchMap */.n)(({
        ...
        if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
          return this.processChildren(childInjector, childConfig, segmentGroup).pipe((0,map/* map */.T)(children => {
            if (children === null) {
              return null;
            }
        ...
        return this.processSegment(childInjector, childConfig, segmentGroup, slicedSegments, matchedOnOutlet ? PRIMARY_OUTLET : outlet, true).pipe((0,map/* map */.T)(child => {
...
function resolveNode(resolve, futureARS, futureRSS, injector) {
  ...
  const data = {};
  return (0,from/* from */.H)(keys).pipe((0,mergeMap/* mergeMap */.Z)(key => getResolver(resolve[key], futureARS, futureRSS, injector).pipe((0,first/* first */.$)(), (0,tap/* tap */.M)(value => {
    data[key] = value;
  }))), takeLast(1), (0,mapTo/* mapTo */.u)(data), (0,catchError/* catchError */.W)(e => isEmptyError(e) ? empty/* EMPTY */.w : (0,observable_throwError/* throwError */.$)(e)));
}
...
let NavigationTransitions = /*#__PURE__*/(() => {
  ...
  class NavigationTransitions {
    ...
    constructor() {
       ...
       */
      this.transitionAbortSubject = new Subject/* Subject */.B();
    ...
    setupNavigations(router, initialUrlTree, initialRouterState) {
      this.transitions = new BehaviorSubject/* BehaviorSubject */.t({
        id: 0,
      ...
      return this.transitions.pipe((0,filter/* filter */.p)(t => t.id !== 0),
      // Extract URL
      (0,map/* map */.T)(t => ({
        ...t,
...
function afterNextNavigation(router, action) {
  ...
  }), (0,filter/* filter */.p)(result => result !== NavigationResult.REDIRECTING), (0,take/* take */.s)(1)).subscribe(() => {
    action();
  });
}
...
let Router = /*#__PURE__*/(() => {
  ...
  class Router {
    ...
    constructor() {
       ...
       */
      this._events = new Subject/* Subject */.B();
      /**
      ...
      this.eventsSubscription = new Subscription/* Subscription */.yU();
...
let RouterLink = /*#__PURE__*/(() => {
  ...
  class RouterLink {
    constructor(router, route, tabIndexAttribute, renderer, el, locationStrategy) {
      ...
      this.commands = null;
      /** @internal */
      this.onChanges = new Subject/* Subject */.B();
      /**
