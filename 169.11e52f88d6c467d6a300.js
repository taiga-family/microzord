"use strict";
(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[169],{
...
var ArgumentOutOfRangeError = __webpack_require__(7108);
...
function last(predicate, defaultValue) {
  ...
  return source => source.pipe(predicate ? (0,filter/* filter */.h)((v, i) => predicate(v, i, source)) : identity/* identity */.y, takeLast(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(() => new EmptyError()));
}
...
function first(predicate, defaultValue) {
  const hasDefaultValue = arguments.length >= 2;
  return source => source.pipe(predicate ? (0,filter/* filter */.h)((v, i) => predicate(v, i, source)) : identity/* identity */.y, (0,take/* take */.q)(1), hasDefaultValue ? defaultIfEmpty(defaultValue) : throwIfEmpty(() => new EmptyError()));
}
...
function prioritizedGuardValue() {
  return (0,switchMap/* switchMap */.w)(obs => {
    return (0,combineLatest/* combineLatest */.aj)(obs.map(o => o.pipe((0,take/* take */.q)(1), (0,startWith/* startWith */.O)(INITIAL_VALUE)))).pipe(scan((acc, list) => {
      let isPending = false;
    ...
    }, INITIAL_VALUE), (0,filter/* filter */.h)(item => item !== INITIAL_VALUE), (0,map/* map */.U)(item => isUrlTree(item) ? item : item === true),
    //
    (0,take/* take */.q)(1));
  });
}
...
class ApplyRedirects {
  ...
  apply() {
    ...
    return urlTrees$.pipe((0,catchError/* catchError */.K)(e => {
  ...
  match(tree) {
    ...
    return mapped$.pipe((0,catchError/* catchError */.K)(e => {
      if (e instanceof NoMatch) {
        throw this.noMatchError(e);
      }
      throw e;
  ...
  expandSegment(ngModule, segmentGroup, routes, segments, outlet, allowRedirects) {
    ...
    }), first(s => !!s), (0,catchError/* catchError */.K)((e, _) => {
      if (e instanceof EmptyError || e.name === 'EmptyError') {
        if (noLeftoversInUrl(segmentGroup, segments, outlet)) {
          return (0,of.of)(new UrlSegmentGroup([], {}));
        }
  ...
  matchSegmentAgainstRoute(ngModule, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      if (route.loadChildren) {
        const loaded$ = route._loadedConfig ? (0,of.of)(route._loadedConfig) : this.configLoader.load(ngModule.injector, route);
        return loaded$.pipe((0,map/* map */.U)(cfg => {
          route._loadedConfig = cfg;
          return new UrlSegmentGroup(segments, {});
        }));
      }
      return (0,of.of)(new UrlSegmentGroup(segments, {}));
    }
    const {
      matched,
      consumedSegments,
    ...
    return childConfig$.pipe((0,mergeMap/* mergeMap */.zg)(routerConfig => {
      ...
      if (childConfig.length === 0 && slicedSegments.length === 0) {
        return (0,of.of)(new UrlSegmentGroup(consumedSegments, {}));
      }
  ...
  getChildConfig(ngModule, route, segments) {
    if (route.children) {
      ...
      return (0,of.of)(new LoadedRouterConfig(route.children, ngModule));
    }
    if (route.loadChildren) {
      // lazy children belong to the loaded module
      if (route._loadedConfig !== undefined) {
        return (0,of.of)(route._loadedConfig);
      }
    ...
    return (0,of.of)(new LoadedRouterConfig([], ngModule));
  }
  runCanLoadGuards(moduleInjector, route, segments) {
    const canLoad = route.canLoad;
    if (!canLoad || canLoad.length === 0) return (0,of.of)(true);
    ...
    return (0,of.of)(canLoadObservables).pipe(prioritizedGuardValue(), (0,tap/* tap */.b)(result => {
...
function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
  return (0,switchMap/* switchMap */.w)(t => applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,map/* map */.U)(urlAfterRedirects => Object.assign(Object.assign({}, t), {
    urlAfterRedirects
  }))));
}
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,mergeMap/* mergeMap */.zg)(t => {
    ...
    if (canDeactivateChecks.length === 0 && canActivateChecks.length === 0) {
      return (0,of.of)(Object.assign(Object.assign({}, t), {
        guardsResult: true
      }));
    }
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector).pipe((0,mergeMap/* mergeMap */.zg)(canDeactivate => {
      return canDeactivate && isBoolean(canDeactivate) ? runCanActivateChecks(targetSnapshot, canActivateChecks, moduleInjector, forwardEvent) : (0,of.of)(canDeactivate);
...
function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
  return (0,from/* from */.D)(checks).pipe(concatMap(check => {
    return (0,concat/* concat */.z)(fireChildActivationStart(check.route.parent, forwardEvent), fireActivationStart(check.route, forwardEvent), runCanActivateChild(futureSnapshot, check.path, moduleInjector), runCanActivate(futureSnapshot, check.route, moduleInjector));
  }), first(result => {
    return result !== true;
  }, true));
}
...
class Recognizer {
  ...
  processSegmentAgainstRoute(route, rawSegment, segments, outlet) {
    ...
    const {
      segmentGroup,
      slicedSegments
    } = split(rawSegment, consumedSegments, rawSlicedSegments,
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,mergeMap/* mergeMap */.zg)(t => {
    ...
    return (0,from/* from */.D)(canActivateChecks).pipe(concatMap(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), (0,tap/* tap */.b)(() => canActivateChecksResolved++), takeLast(1), (0,mergeMap/* mergeMap */.zg)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,of.of)(t) : empty/* EMPTY */.E));
  });
}
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,from/* from */.D)(keys).pipe((0,mergeMap/* mergeMap */.zg)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,tap/* tap */.b)(value => {
    data[key] = value;
...
let Router = /*#__PURE__*/(() => {
  class Router {
    ...
    setupNavigations(transitions) {
      ...
      return transitions.pipe((0,filter/* filter */.h)(t => t.id !== 0),
      // Extract URL
      ...
      (0,switchMap/* switchMap */.w)(t => {
        ...
        })), checkGuards(this.ngModule.injector, evt => this.triggerEvent(evt)), (0,tap/* tap */.b)(t => {
        ...
        switchTap(t => {
          if (t.guards.canActivateChecks.length) {
            return (0,of.of)(t).pipe((0,tap/* tap */.b)(t => {
              ...
              return (0,of.of)(t).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), (0,tap/* tap */.b)({
        ...
        }), activateRoutes(this.rootContexts, this.routeReuseStrategy, evt => this.triggerEvent(evt)), (0,tap/* tap */.b)({
          next() {
            completed = true;
          },
          complete() {
...
let RouterLinkActive = /*#__PURE__*/(() => {
  class RouterLinkActive {
    ...
    ngAfterContentInit() {
      ...
      (0,of.of)(this.links.changes, this.linksWithHrefs.changes, (0,of.of)(null)).pipe((0,mergeAll/* mergeAll */.J)()).subscribe(_ => {
        this.update();
...
let RouterPreloader = /*#__PURE__*/(() => {
  class RouterPreloader {
    ...
    setUpPreloading() {
      this.subscription = this.router.events.pipe((0,filter/* filter */.h)(e => e instanceof NavigationEnd), concatMap(() => this.preload())).subscribe(() => {});
    }
    preload() {
    ...
    preloadConfig(ngModule, route) {
      return this.preloadingStrategy.preload(route, () => {
        const loaded$ = route._loadedConfig ? (0,of.of)(route._loadedConfig) : this.loader.load(ngModule.injector, route);
