"use strict";
(self["webpackChunkdemo"] = self["webpackChunkdemo"] || []).push([[476],{
...
let ReactChildComponent = /*#__PURE__*/(() => {
  class ReactChildComponent {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/core_mjs_["ɵɵdefineComponent"]({
      ...
      dependencies: [taiga_ui_core_components_link/* TuiLinkComponent */.V, taiga_ui_addon_doc_components/* TuiDocPageComponent */.qo, router_mjs_.RouterLink],
      changeDetection: 0
    });
  }
...
let ReactChildModule = /*#__PURE__*/(() => {
  class ReactChildModule {
    ...
    static #_3 = this.ɵinj = /*@__PURE__*/core_mjs_["ɵɵdefineInjector"]({
      imports: [taiga_ui_core_components_link/* TuiLinkModule */.j, taiga_ui_addon_doc.TuiAddonDocModule, router_mjs_.RouterModule.forChild((0,taiga_ui_addon_doc_utils/* tuiGenerateRoutes */.Ve)(ReactChildComponent))]
    });
  }
