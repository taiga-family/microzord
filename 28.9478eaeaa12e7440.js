...
let ReactChildComponent = /*#__PURE__*/(() => {
  class ReactChildComponent {
    ...
    static #_2 = this.ɵcmp = /*@__PURE__*/core_mjs_["ɵɵdefineComponent"]({
      ...
      dependencies: [taiga_ui_core_components_link/* TuiLinkComponent */.C, taiga_ui_addon_doc_components/* TuiDocPageComponent */.EF, router_mjs_.RouterLink],
      changeDetection: 0
    });
  }
...
let ReactChildModule = /*#__PURE__*/(() => {
  class ReactChildModule {
    ...
    static #_3 = this.ɵinj = /*@__PURE__*/core_mjs_["ɵɵdefineInjector"]({
      imports: [taiga_ui_core_components_link/* TuiLinkModule */.w, taiga_ui_addon_doc.TuiAddonDocModule, router_mjs_.RouterModule.forChild((0,taiga_ui_addon_doc_utils/* tuiGenerateRoutes */._A)(ReactChildComponent))]
    });
  }
